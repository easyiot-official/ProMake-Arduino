...
*/
#ifndef _ProMake_GSM_M66_BaseProvider_
#define _ProMake_GSM_M66_BaseProvider_

//#include <ProMake_GSM_SoftSerial.h>

enum ProMake_GSM_commandType_e { XON, NONE, MODEMCONFIG, ALIVETEST, BEGINSMS, ENDSMS, AVAILABLESMS, FLUSHSMS,
...
class ProMake_GSM_M66_BaseProvider
{
	public:
