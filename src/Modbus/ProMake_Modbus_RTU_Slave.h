...
class ProMake_Modbus_RTU_Slave {
  public:
    ProMake_Modbus_RTU_Slave(ProMake_RS485& serial, uint8_t *buf, uint16_t bufSize, uint32_t responseDelay = 0);
