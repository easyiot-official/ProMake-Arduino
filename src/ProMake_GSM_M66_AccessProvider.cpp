...
*/
#include <ProMake_GSM_M66_AccessProvider.h>
#include <Arduino.h>
...
ProMake_GSM_M66_AccessProvider::ProMake_GSM_M66_AccessProvider(bool debug)
{
	theGSM3ShieldV1ModemCore.setDebug(debug);

}

void ProMake_GSM_M66_AccessProvider::manageResponse(byte from, byte to)
{
...
// May be synchronous
GSM3_NetworkStatus_t ProMake_GSM_M66_AccessProvider::begin(char* pin, bool restart, bool synchronous)
{	
...
//HWrestart.
int ProMake_GSM_M66_AccessProvider::HWrestart()
{
	#ifdef TTOPEN_V1
	digitalWrite(__POWERPIN__, HIGH);
	delay(1000);
...
//HWrestart.
int ProMake_GSM_M66_AccessProvider::HWstart()
{
...
int ProMake_GSM_M66_AccessProvider::ModemConfiguration(char* pin)
{
...
void ProMake_GSM_M66_AccessProvider::ModemConfigurationContinue()
{
	bool resp;
...
int ProMake_GSM_M66_AccessProvider::isAccessAlive()
{
...
void ProMake_GSM_M66_AccessProvider::isModemAliveContinue()
{
bool rsp;
...
//Shutdown.
bool ProMake_GSM_M66_AccessProvider::shutdown()
{
	unsigned long m;
	bool resp;
	char auxLocate [18];
...
//Secure shutdown.
bool ProMake_GSM_M66_AccessProvider::secureShutdown()
{
	// It makes no sense to have an asynchronous shutdown
	pinMode(__RESETPIN__, OUTPUT);
	digitalWrite(__RESETPIN__, HIGH);
