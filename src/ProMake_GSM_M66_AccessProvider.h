...
class ProMake_GSM_M66_AccessProvider : public ProMake_GSM_MobileAccessProvider, public ProMake_GSM_M66_BaseProvider
{
	private:
	...
	public:
		...
		ProMake_GSM_M66_AccessProvider(bool debug=false);
		...
		*/
		inline ProMake_GSM_NetworkStatus_t getStatus(){return theProMakeGsmM66ModemCore.getStatus();};
