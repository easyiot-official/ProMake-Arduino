...
class ProMake_GSM_SoftSerialMgr
{
	public:
...
class ProMake_GSM_SoftSerial : public ProMake_GSM_CircularBufferManager
{
	private:
		...
		static ProMake_GSM_SoftSerial* _activeObject;
		ProMake_GSM_SoftSerialMgr* mgr;
	  ...
	  public:
		...
		ProMake_GSM_CircularBuffer cb; // Circular buffer
		
		/** Register serial manager
			@param manager		Serial manager
		 */
		inline void registerMgr(ProMake_GSM_SoftSerialMgr* manager){mgr=manager;};
