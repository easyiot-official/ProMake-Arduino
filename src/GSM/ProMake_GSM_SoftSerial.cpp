...
*/
#include "ProMake_GSM_SoftSerial.h"
#include "ProMake_GSM_M66_IO.h"
...
#error This version of ProMake_GSM_SoftSerial supports only 20, 16 and 8MHz processors

#endif

ProMake_GSM_SoftSerial* ProMake_GSM_SoftSerial::_activeObject=0;

ProMake_GSM_SoftSerial::ProMake_GSM_SoftSerial():
...
int ProMake_GSM_SoftSerial::begin(long speed)
{
...
void ProMake_GSM_SoftSerial::close()
 {
	_activeObject=0;
 }

size_t ProMake_GSM_SoftSerial::write(uint8_t c)
{
	if (_tx_delay == 0)
		return 0;
...
size_t ProMake_GSM_SoftSerial::finalWrite(uint8_t c)
{
...
/*inline*/ void ProMake_GSM_SoftSerial::tunedDelay(uint16_t delay) { 
  uint8_t tmp=0;
...
void ProMake_GSM_SoftSerial::tx_pin_write(uint8_t pin_state)
{
...
void ProMake_GSM_SoftSerial::setTX()
{
...
void ProMake_GSM_SoftSerial::setRX()
{
...
//#define __RXINT__ 1
  attachInterrupt(__RXINT__, ProMake_GSM_SoftSerial::handle_interrupt, FALLING);
#endif
	// This line comes from the High Middle Ages...
	// attachInterrupt(__RXINT__, ProMake_GSM_SoftSerial::handle_interrupt, FALLING);
}

void ProMake_GSM_SoftSerial::handle_interrupt()
{
	if(_activeObject)
		_activeObject->recv();
}

uint8_t ProMake_GSM_SoftSerial::rx_pin_read()
{
  // Digital port manipulation
  return *_receivePortRegister & _receiveBitMask;
}

void ProMake_GSM_SoftSerial::recv()
{
...
bool ProMake_GSM_SoftSerial::keepThisChar(uint8_t* c)
{
...
void ProMake_GSM_SoftSerial::spaceAvailable()
{
...
void ProMake_GSM_SoftSerialMgr::manageMsg(byte from, byte to){};
...
ISR(PCINT0_vect)
{
  ProMake_GSM_SoftSerial::handle_interrupt();
}
#endif
