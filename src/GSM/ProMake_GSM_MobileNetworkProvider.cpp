...
*/
#include "ProMake_GSM_MobileNetworkProvider.h"

ProMake_GSM_MobileNetworkProvider* theProvider;

ProMake_GSM_MobileNetworkProvider::ProMake_GSM_MobileNetworkProvider()
{
	socketsAsServer=0x0000;
};


int ProMake_GSM_MobileNetworkProvider::getNewOccupiedSocketAsServer()
{
	int i;
...
bool ProMake_GSM_MobileNetworkProvider::getStatusSocketAsServer(uint8_t socket)
{
