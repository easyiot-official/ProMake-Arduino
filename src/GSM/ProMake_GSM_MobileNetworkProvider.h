...
*/
#ifndef _ProMake_GSM_MOBILENETWORKPROVIDER_
#define _ProMake_GSM_MOBILENETWORKPROVIDER_

#include "ProMake_GSM_MobileAccessProvider.h"
#include <inttypes.h>
#include <stddef.h>
#include <IPAddress.h>
		
class ProMake_GSM_MobileNetworkProvider 
{
	private:
	...
	public:
		...
		/** Constructor */
		ProMake_GSM_MobileNetworkProvider();
		
		/** Get network status
			@return network status
		 */
		virtual inline ProMake_GSM_NetworkStatus_t getStatus(){return ERROR;};
...
extern ProMake_GSM_MobileNetworkProvider* theProvider;
