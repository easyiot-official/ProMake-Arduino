...
*/
#ifndef __ProMake_GSM_CIRCULARBUFFER__
#define __ProMake_GSM_CIRCULARBUFFER__
...
class ProMake_GSM_CircularBufferManager
{
	public:
...
class ProMake_GSM_CircularBuffer
{
	private:
		// Buffer pointers. 
		...
		ProMake_GSM_CircularBufferManager* cbm; // Circular buffer manager
	...
	public:
		 ...
		 */
		ProMake_GSM_CircularBuffer(ProMake_GSM_CircularBufferManager* mgr=0);
